            ...
            <main style="background: white;">
                ...
                <form action="addPerfumeManager" method="POST" style="justify-items: center;">
                    <div class="perfume-info" style="display: block;width: 40%;">
                        <div class="left-info">
                            <ul>
                                <li  style="border-radius: 25px; height: 30px;border: solid;"><label>Perfume ID: </label><input type="text" name="perfume_id" value="${perfume_id}" readonly style="width: 370px;"></li>
                                <li  style="border-radius: 25px;height: 30px;border: solid;"><label>Perfume Name: </label><input type="text" name="perfume_name" value style="width: 370px;"></li>
                                <li  style="border-radius: 25px; height: 30px;border: solid;"><label>Price: </label><input type="number" name="price" value style="width: 370px;"><label>$</label></li>
                                <li  style="border-radius: 25px; height: 30px;border: solid;"><label>Sale: </label><input type="number" name="sale" value style="width: 370px;"><label>%</label></li>
                                <li  style="border-radius: 30px;border: solid;">
