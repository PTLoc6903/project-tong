...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid" style="min-height: 155vh; padding-top: 90px;">
            <div class="title mx-auto my-5" style="color: white; background-color: #ff7c7c">Customer Information</div>
            ...
            <div class="title mx-auto my-5" style="color: white; background-color: #ff7c7c">Orders</div>
