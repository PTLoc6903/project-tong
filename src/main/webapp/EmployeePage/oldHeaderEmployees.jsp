        ...
        <div class="container-fluid m-0 p-0">
            <div class="header d-flex justify-content-around my-0 align-items-center">
                <div class="brand d-flex align-items-center">
                    <div class="logo">
                        <a href="/employee/orderListEmployees"><img src="/img/logo.png" alt="Logo Perfume Store"/></a> 
                    </div>
                ...
                <div class="flex-fill d-flex justify-content-center">
                    ...
                    <c:choose>
                        <c:when test="${sessionScope.phone!=null}">
                            <a href="/employee/orderListEmployees" class="btn btn-outline-danger mx-1">Order List</a>
                        </c:when>
                        <c:otherwise>
                            <a href="/employee/loginEmployees" class="btn btn-outline-danger mx-1">Order List</a>
                        </c:otherwise>
                    </c:choose>
                    <a href="/employee/newOrderListEmployees" class="btn btn-outline-danger mx-1">New Order</a>
                </div>
                <div class="profile d-flex align-items-center">
                    ...
                    <div class="nameAccount">
                        ...
                        <div class="profileBox" id="profileBox">
                            <a href="/employee/loginEmployees"><div>Login</div></a>
                        </div>
                    </div>
                    <%} else {%>
                    <div class="nameAccount">
                    ...
                    <div class="profileBox" id="profileBox" name="profile">
                        <a href="/employee/updateProfileEmployees" name="updateProfile" >Update Profile</a>
                        <a href="/employee/changePasswordEmployees" name="updateProfile" >Change Password</a>
                        <a href="/employee/logoutEmployees"><div>Logout</div></a>
                    </div>
                    <%}%>
