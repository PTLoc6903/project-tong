    ...
    <body>
        ...
        <div class="container-i">
            ...
            <main style="background: white;">
                ...
                <!-- Add Perfume Table -->
                <h2 style="font-size:40px;">Enter Account Information</h2>
                <form id="createAccountForm" action="createAccount" method="POST" style="justify-items: center;margin-left: -100px;">
                    <div class="acc-info" style="display:block; width: 80%; ">
                        <div class="right-info">
                            <ul>
                                <li style="border: 1px solid"><label>Name: *</label><input id="name" type="text" name="name" value  style="width: 800px;"></li>
                                <li style="border: 1px solid"><label>Phone: *</label><input id="phone" type="number" name="phone" value  style="width: 800px;"></li>
                                <li style="border: 1px solid"><label>Password: *</label><input id="password" type="text" name="password" style="width: 800px;"></li>
                            </ul>
                        </div>
                        <div class="right-info">
                            <ul>
                                <li style="border: 1px solid"><label>Email: *</label><input id="email" type="text" name="email" value  style="width: 800px;"></li>
                                ...
                                <li style="border: 1px solid"><label>Address: </label>
                                    <textarea style="resize: none;width: 900px;" id="address" cols="30" rows="3" name="address"></textarea>
                                </li>
                            </ul>
                            <div class="btn-product" style="margin-left: 37%">
