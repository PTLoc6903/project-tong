...
<html>
    ...
    <body>
        ...
        <div class="container light-style flex-grow-1 container-p-y" style="display: flex; align-content: center; justify-content: center">
            <h4 class="font-weight-bold py-3 mt-2">
                Customer Profile
            </h4>
            <div class="card overflow-hidden" style="margin-bottom: 20px; width: 700px; margin-top: 20px; margin-left: 20px">
