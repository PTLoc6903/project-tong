...
public class ListMenuController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ListMenuManager</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ListMenuManager at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            listBestSeller = perfumeDao.getListBestSeller();
            listMenu = perfumeDao.getListMenu();

            request.setAttribute("bestSeller", listBestSeller);
            request.setAttribute("menu", listMenu);

            request.getRequestDispatcher("listMenuManager.jsp").forward(request, response);
        } catch (Exception ex) {
