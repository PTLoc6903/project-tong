...
import daoEmployees.OrderDetailDAO;
...
public class OrderDetailController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (path.startsWith("/orderDetailEmployees/updateSuccess")) {
            ...
            request.getRequestDispatcher(folder + "/orderDetailEmployees.jsp").forward(request, response);

        } else if (path.startsWith("/orderDetailEmployees/updateFail")) {
            String[] data = path.split("/");
            String id = data[data.length - 1];
            OrderDetailDAO odd = new OrderDetailDAO();
            OrderDAO ord = new OrderDAO();
        ...
        } else if (path.startsWith("/orderDetailEmployees")) {
            String[] data = path.split("/");
            String id = data[data.length - 1];
            OrderDetailDAO odd = new OrderDetailDAO();
            OrderDAO ord = new OrderDAO();
