                    ...
                    <div class="box1" style="background: #ffffff;">
                        <form id="updateForm" method="post" action="/employee?orderId=<%= orderId%>">
                            ...
                            <div class="customer-info mt-4">
                                <div style="font-size:20px;">Customer: <span><%= customerInfo.getString("cus_name")%></span> <a id="more" href="/employee/customerInfoEmployees/<%=orderId%>/<%= customerInfo.getString("cus_phone")%>"><i class="fa-solid fa-circle-info"></i></a></div>
                                <div style="font-size:20px;">Address: <span><%= customerInfo.getString("cus_address")%></span></div>
                                <div style="font-size:20px;">Phone: <span><%= customerInfo.getString("cus_phone")%></span></div>
                                <div style="font-size:20px;">Payment: <span><%= customerInfo.getString("ord_pay")%></span></div>
                                <div style="font-size:20px;">Type: <span><%= customerInfo.getString("ord_type")%></span></div>
                                <div style="font-size:20px;">Order date: <span><%= customerInfo.getString("ord_date")%></span></div>
                                <div style="font-size:20px;">Note: <span><%= customerInfo.getString("ord_note")%></span></div>
                                <div class="d-flex flex-inline justify-content-start align-items-center gap-3">
                                    <div class="btnUpdate text-center">
                                        <button id="btnUpdateStatus" type="submit" name="btnUpdateStatus" value="Update">Update</button>
                                    </div>
                                    <div class="back">
                                        <input type="button" class="submit" value="Back" onclick="window.location.href = '/employee/orderListEmployees';"  style="width: 150px; font-size: 20px;height: 50px; background: red; color: white; font-weight:bold; border-radius: 5px">
                                    </div>
                                </div>
