...
<html>
    <head>
        ...
        <style>
            body {
                ...
                height: 100vh;
                margin: 0;
                background-image: url('../img/perfume-shop-classic-vintage.jpg');
    ...
    <body>
        ...
        <div class="main-content">
            <div class="container" style="max-width: 400px; background-color: rgba(0, 0, 0, 0.5)">
                <form action="/employee" method="post">
                    <div class="form-header" style="color: yellow;">Forgot Password</div>
        ...
        <script>
            document.querySelector('form').addEventListener('submit', function (event) {
                ...
                response.sendRedirect("/loginEmployees");
            });
        </script>
    </body>
</html>
