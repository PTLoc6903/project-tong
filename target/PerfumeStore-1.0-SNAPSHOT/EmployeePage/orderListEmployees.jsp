    ...
    <body>
        ...
        <div class="container-fluid" style="min-height: 100vh; padding-top: 150px;">
            <div class="d-flex justify-content-center">
                <div class="d-flex justify-content-center px-2 py-1 title my-3" style="color: black; background: white; font-size:50px ">Order List</div>
            </div>
                        ...
                        <tbody id="itemList">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    %>
                                    <div class="btn btn-primary" style="background-color: blue; color: white; padding: 5px; border-radius: 10px; width:100px; text-align: center ; height: 35px"><%= rs.getString("ord_status")%></div>
                                    <%
                                    } else if (status.equals("Completed")) {
                                    %>
                                    <div class="btn btn-success" style="background-color: green; color: white; padding: 5px; border-radius: 10px; width:100px; text-align: center ; height: 35px"><%= rs.getString("ord_status")%></div>
                                    <%
                                    } else if (status.equals("Waiting")) {
                                    %>
                                    <div class="btn btn-warning" style="background-color: orange; color: white; padding: 5px; border-radius: 10px; width:100px; text-align: center ; height: 35px"><%= rs.getString("ord_status")%></div>
                                    <%
                                    } else if (status.equals("Rejected")) {
                                    %>
                                    <div style="background-color: gray; color: white; padding: 5px; border-radius: 10px; width:100px; text-align: center; height: 35px"><%= rs.getString("ord_status")%></div>
                                    <%
                                    } else if (status.equals("Cancelled")) {
                                    %>
                                    <div style="background-color: red; color: white; padding: 5px; border-radius: 10px; width:100px; text-align: center ; height: 35px"><%= rs.getString("ord_status")%></div>
                                    <%
                                        }
                                    %>
                                </td>
